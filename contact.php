...
if(isset($_POST['form_contact']))
{
    ...
    if($valid == 1)
    {
        ...
        // Uncomment the line below to send the email (it is commented for testing purposes)
        // mail($to_admin, $subject, $message, $headers); 

        // Insert contact form data into the database
        $statement = $pdo->prepare("INSERT INTO tbl_contact_form (name, email, phone, message) VALUES (?, ?, ?, ?)");
        $statement->execute([$visitor_name, $visitor_email, $visitor_phone, $visitor_message]);
