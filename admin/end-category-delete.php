...
// Populate $p_ids array with product ids
foreach ($result as $row) {
    $p_ids[] = $row['p_id'];
}

// Check if there are products before proceeding with deletion
if (count($p_ids) > 0) {
    for ($i = 0; $i < count($p_ids); $i++) {

        // Getting featured photo ID to unlink from folder
        ...
        // Getting other photo IDs to unlink from folder
        ...
        // Delete related payments and orders
